...
class StudentListVC: UIViewController {
    ...
    {
        let alert = UIAlertController(title: "Add Student", message: "Fill Down The Details", preferredStyle: .alert)
...
extension StudentListVC: UITableViewDataSource ,UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print(indexPath.row)
        let alert = UIAlertController(title: "Update Student", message: "Update The Details", preferredStyle: .alert)
        let stud = studArray[indexPath.row]
